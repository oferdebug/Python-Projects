    ...
    def __init__(self):
        ...
        self.questions = [{
            ...
            "options": [
                ...
                "Central Processor Unit", "Computer Processor Unit"
            ],
            "answer":
            "Central Processing Unit"
        }, {
            "question":
            "Which programming language is widely used for web development and is known for its flexibility and simplicity?",
            ...
            "options": [
                "To store the operating system", "To store data permanently",
                "To store frequently accessed data and programs for quick access by the CPU",
            ...
            "question":
            "Which component of a computer connects all its parts together and allows data to be transferred between them?",
            ...
            "options": [
                "Super Speed Drive", "Solid State Drive",
                "System Storage Device", "Secure Software Drive"
            ],
            "answer":
            "Solid State Drive"
        }, {
            "question":
            "Which networking protocol is commonly used for sending emails?",
            ...
            "options": [
                "Virtual Personal Network", "Virtual Private Network",
                "Verified Personal Network", "Very Private Network"
            ],
            "answer":
            ...
            "options": [
                "To protect against physical theft of hardware",
                "To prevent unauthorized access to or from a private network",
                "To recover lost data", "To clean viruses from the system"
            ],
            "answer":
            "To prevent unauthorized access to or from a private network"
        }]
